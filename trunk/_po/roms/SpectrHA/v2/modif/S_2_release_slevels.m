function S_2_release_slevels(where)
%function S_2_release_slevels(where)
...
%                 see settings.m to change default values
%
...
time=ETC.release_t1; % edit settings.m                               |
                                                                     %
% time to see data in time evolution                                 |
%t2=1;  % time2                                                      |
t2=ETC.release_t2;   % edit settings.m                               |
%--------------------------------------------------------------------|
...
if is_j
  ...
  for nsta=1:size(stations,1)
    lon_=lon(stations(nsta,2));
    plot([lon_ lon_],[h_pos 5],'k')
    txt=text(lon_,h_pos,num2str(stations(nsta,2)));
    set(txt,'HorizontalAlignment','center','VerticalAlignment','top');
    set(txt,'fontsize',5);
  end
end
%«««««««««««««««««««««««««««««««««««««««««««««««««««««««««««««««««««««
