...
%   01-08-2005 - OPT=1 1 1 1, be default, before was 1 1 0 0
%      05-2007 - A couple of small enhancements
%   09-07-2008 - Change LENG_STR form 25 top inf (UFBA, Brasil)
...
if show_att
  ...
  for i=1:length(a)
    ...
    if isnumeric(attrib.value{i})
      ...
      if any(size(attrib.value{i}) == 1) & length(attrib.value{i}) <= 10
        %attrib.value{i} = ['<numeric: ',num2str(attrib.value{i}),'>'];
        attrib.value{i} = num2str(attrib.value{i});
      else
