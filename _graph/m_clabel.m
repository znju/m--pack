...
%         'ncd'      number of decimals (by default uses str2num)
%
%   Output:
...
while strcmp(button,'normal')
  ...
  if  strcmp(button,'normal')
      ...
      if isempty(ncd)
        ...
        v=sprintf(['%.',int2str(ncd),'f'],val);
      end

      markers(cont) = plot(xx,yy,'MarkerSize',markersize,'Color',markercolor,'Marker',marker);
      labels(cont)  = text(xx,yy,v,'FontSize',fontsize,'FontName',fontname,'Color',fontcolor,...
